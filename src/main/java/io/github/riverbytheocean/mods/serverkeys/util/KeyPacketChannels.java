package io.github.riverbytheocean.mods.serverkeys.util;
...
public class KeyPacketChannels {
    ...
    public static final ResourceLocation KEY_CHANNEL = ResourceLocation.fromNamespaceAndPath("riverkeys", "keybind");
